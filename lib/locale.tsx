...
const dictionary = {
  en: {
    ...
    sections: {
      ...
      technologies: { eyebrow: "05", title: "Tech stack", description: "Languages, frameworks and tools I use day to day." },
  ...
  es: {
    ...
    sections: {
      ...
      technologies: { eyebrow: "05", title: "Stack tecnológico", description: "Lenguajes, frameworks y herramientas que uso en mi día a día." },
